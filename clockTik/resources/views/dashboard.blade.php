...
@section('userDashboard')
    ...
    @else
        @if ($shiftStatus == true && $breakStatus == false)
            <a onclick="return confirm('Are you sure you want to take a break?')" href="{{ route('break') }}" class="breakButton">
                <p class="buttonText">Break</p>
            </a>
            <a onclick="return confirm('Are you sure you want to quit your shift?')" href="{{ route('stop') }}" class="stopButton">
                <p class="buttonText">Stop</p>
            </a>
        @else
            @if ($shiftStatus == true && $breakStatus == true)
                <a onclick="return confirm('Are you sure you want to start working again?')" href="{{ route('stopBreak') }}" class="breakButton">
